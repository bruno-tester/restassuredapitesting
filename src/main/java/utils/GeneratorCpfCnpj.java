...
@Data
public class GeneratorCpfCnpj {

    private GeneratorCpfCnpj() { throw new IllegalStateException("Utility class"); }
    ...
    public static int digitValidate(int digito) {
        int d = 11 - (mod(digito, 11));
